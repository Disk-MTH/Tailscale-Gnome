...
export class QuickSettingsScroll {
    ...
    _apply() {
        ...
        // y_expand stays off, and that one is load-bearing. The grid reserves
        // room for an open submenu through a placeholder whose height is
        // bound to this actor's; an overlay stretched to the stack's height
        // would feed the grid's own height back into it and the layout would
        // never settle.
        overlay.set({
            x_expand: true,
            y_expand: false,
