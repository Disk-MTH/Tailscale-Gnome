 ...
 */
function _makeCopyControl({
    iconName, targets, onCopy, open = false, onToggle = () => {},
}) {
...
// A non-interactive line of text, used for the "nothing here" placeholders
// that stand in for an empty peer or exit-node list.
