...
const RoutesSubToggle = GObject.registerClass(
    class RoutesSubToggle extends PopupMenu.PopupSubMenuMenuItem {
        _init(onToggle) {
            ...
            // toggles the setting.
            this._triangleSignalId = 0;
            if (this._triangleBin) {
                this._triangleBin.reactive = true;
                this._triangleBin.track_hover = true;
                this._triangleSignalId = this._triangleBin.connect(
                    'button-press-event', (_a, _e) => {
                        this.menu.toggle();
        ...
        destroy() {
            if (this._triangleSignalId && this._triangleBin) {
                this._triangleBin.disconnect(this._triangleSignalId);
                this._triangleSignalId = 0;
            }
            super.destroy();
        }
