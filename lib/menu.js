...
export const TailscaleToggle = GObject.registerClass(
    class TailscaleToggle extends QuickSettings.QuickMenuToggle {
        ...
        //   IP row
        //   Account submenu               ← active account in its label
        //   ─────
        //   Peers submenu                 ← Peers first, exit nodes second
        //   Exit node submenu
        //   ─────
        //   ☑ Accept DNS    [suffix]      ← DNS before Routes
        //   ☑ Accept routes [N advertised]
        //   ☐ Allow LAN access
        //   ☐ Shields up
        //   ☐ Run SSH server
        //   ─────
        //   Tailnet routes submenu        ← only when non-empty
        //   ─────
        //   Refresh
        //   Extension settings
        ...
        _renderRoutes(snap) {
            ...
            // Hide the whole "Tailnet routes" submenu and its separator when
            // nothing is advertised.
            this._routesSubMenu.visible = n > 0;
            this._routesSeparator.visible = n > 0;
            if (n === 0) return;
