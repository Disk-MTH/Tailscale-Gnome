...
export const TailscaleToggle = GObject.registerClass(
    class TailscaleToggle extends QuickSettings.QuickMenuToggle {
        ...
        _onUserClick() {
            ...
            // arrow is gone in this state. The notification is the whole
            // answer, so the switch goes back where it was and stops there.
            if (!requireBackend(snap, Category.CONNECTION)) {
                this.checked = false;
                return;
            }
