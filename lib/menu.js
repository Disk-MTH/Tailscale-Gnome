...
// In-shell numeric entry, same visual family as SendFileDialog. Replaces
// the previous zenity subprocess.
const PortDialog = GObject.registerClass(
    class PortDialog extends ModalDialog.ModalDialog {
        ...
        _commit() {
            this._finish(this._entry.get_text());
        }
    ...
    class TailscaleToggle extends QuickSettings.QuickMenuToggle {
        ...
        async _runAddFunnelFlow() {
            const text = await new Promise((resolve) => {
                this._showDialog(new PortDialog({ onPick: resolve }));
            });
