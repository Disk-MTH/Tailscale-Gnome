...
export const TailscaleToggle = GObject.registerClass(
    class TailscaleToggle extends QuickSettings.QuickMenuToggle {
        ...
        _buildMenu() {
            ...
            // Taildrop: toggle to accept inbound files, action to send.
            this._taildropSeparator = new PopupMenu.PopupSeparatorMenuItem();
            this.menu.addMenuItem(this._taildropSeparator);
